...
class Net(nn.Module):
    def __init__(self):
        ...
        model_cfg_file = '/content/drive/My Drive/kaggle/covid19-det/nbs/py/hengck_code/dummy_01a/yolov5x-768/yolo5/models/yolov5x.yaml'
        pretrain_file  = '/content/yolov5x.pt'
        e = Model(
            cfg=model_cfg_file,
            ch=3,
            nc=1,
